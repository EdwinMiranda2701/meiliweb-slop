<template>
  <button
    type="button"
    v-tippy="t('label')"
    class="focus:ring-primary-500 relative ml-5 flex-shrink-0 rounded-full bg-white p-1 text-gray-800 hover:text-gray-600 focus:ring-2 focus:ring-offset-2 focus:outline-none"
    @click="confirmLogout()">
