<template>
  <TransitionRoot as="template" :show="state.open">
    <Dialog as="div" class="relative z-40" @close="state.open = false">
      <TransitionChild
        as="template"
          ...
          <TransitionChild
            ...
            <DialogPanel
              ...
              <div class="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                <button
                  type="button"
                  class="focus:ring-primary-500 rounded-md text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-offset-2 focus:outline-none dark:text-gray-200"
...
import { type MaybeRef, reactive, ref, watch } from 'vue'
