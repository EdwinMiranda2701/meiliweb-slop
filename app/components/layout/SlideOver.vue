            ...
            <TransitionChild
              ...
              <DialogPanel class="pointer-events-auto w-screen max-w-lg">
                <div class="flex h-full flex-col overflow-y-auto bg-white/95 py-6 shadow-xl">
                  <div class="px-4 sm:px-6">
                    <div class="flex items-start" :class="title ? 'justify-between' : 'justify-end'">
                      ...
                      <div class="ml-3 flex h-7 items-center">
                        <button
                          type="button"
                          class="focus:ring-primary-500 relative rounded-md bg-white text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-offset-2 focus:outline-none"
                          @click="open = false">
                  ...
                  <div class="relative mt-6 flex-1" :class="noPadding ? undefined : 'px-4 sm:px-6'">
                    <slot />
                  </div>
                </div>
              </DialogPanel>
